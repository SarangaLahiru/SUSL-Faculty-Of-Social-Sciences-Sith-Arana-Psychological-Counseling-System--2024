        ...
        <div class="proton-wrapper">
            <table class="proton-table">
                <tbody>
                    ...
                    <tr class="proton-tr">
                        <td class="proton-td" colspan="10">
                            <h2>Welcome to Sitharana Psychological Counseling Center!</h2>
                            <p>We are delighted to welcome you as a new counselor in the <strong>Sitharana Counseling Center</strong> at Sabaragamuwa University of Sri Lanka. Below are your credentials to access the system:</p>
                            <center>
                                <div class="proton-code">
                                    Password: <span>{{ $password }}</span>
                                </div>
                            </center>
                            <p style="text-align: center; color: #e63946; margin-top: 10px;">Please change your password after logging in for the first time.</p>
                        </td>
                    </tr>
                    ...
                    <tr class="proton-tr">
                        <td class="proton-td" colspan="10">
                            <center>
                                <a href="{{ url('counsellor/login') }}" class="proton-button" target="_blank">Log In</a>
                            </center>
                        </td>
                    </tr>
                    ...
                    <tr class="proton-tr">
                        <td class="proton-td" colspan="10">
                            ...
                            <center>
                                <span class="proton-footer"> © 2024 Sitharana Psychological Counseling Center, SUSL</span>
                            </center>
                            <div class="proton-margin"></div>
                        </td>
                    </tr>
